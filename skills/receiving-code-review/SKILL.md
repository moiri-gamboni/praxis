...
description: Use when receiving code review feedback OR adversarial design review (red-team) feedback, before implementing suggestions, especially if feedback seems unclear, complexity-positive, or technically questionable - requires technical rigor and verification, not performative agreement or blind implementation
---
